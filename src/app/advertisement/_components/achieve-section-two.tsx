...
const features = [
    {
        ...
        text: (
            <>
                <span>$1.3 Million in Revenue:</span> Scaled Togs Clothing using Google & Meta Ads.
            </>
        ),
    },
    {
        ...
        text: (
            <>
                <span>300% Conversion Growth:</span>  Clients experience a <span>3X boost</span> in just 90 days.
            </>
        ),
    },
    {
        ...
        text: (
            <>
                <span>High ROI:</span> Our expert Google & Meta Ads strategy turned a $71K ad spend into $253K in sales in just one month, delivering an impressive <span>3X-5X ROI</span>
            </>
        ),
    },
    {
        ...
        text: (
            <>
                <span>Client Endorsement: &quot;Honest and professional. Communicated regularly and set realistic expectations. A pleasure to work with.&quot;</span>
            </>
        ),
    },
    {
    ...
    },
    {
        ...
        text: (
            <>
                <span>Full Transparency:</span> Get <span>real-time dashboards & daily tracking.</span>
            </>
        ),
    },
];
