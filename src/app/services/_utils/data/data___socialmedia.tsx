...
const data___socialmedia = {
    ...
    limitedOffer: {
      ...
      image: "https://utfs.io/f/TLm9XcQ0Drp9VpRj6CXtzjwcuqoVvpZmxNrkdWPhDefA1Mb2",
      body: {
        para: (
          <>
    ...
    endingFunnel: {
      ...
      image: "https://utfs.io/f/TLm9XcQ0Drp9TB9OUL0Drp9QHEhgBxGijknalAF6yNqR0POo",
      body: (
        <>
...
export default data___socialmedia;
