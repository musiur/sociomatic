...
export const ServicePageCOPY = {
  ...
  customwebdev: {
    ...
    whyWeAndWhatWeDo: {
      tagline: <>Tailored Solutions, Trusted Results</>,
        ...
        benefits: [
          {
            ...
            paragraph: (
              <>
                Our approach to website and web app development is tailored to
                your specific business needs, ensuring that your website
                reflects your unique brand identity and objectives
              </>
            ),
          },
          {
    ...
    userEmpathy: {
      ...
      body: (
        <>
          We comprehend the obstacles businesses encounter in establishing a
          robust online presence. Our empathetic team listens attentively to
          your requirements and transforms your vision into a captivating
          website that captivates your audience and drives results.
        </>
      ),
    },
    coreBenefits: {
        ...
        benefits: [
          {
            ...
            para: (
              <>
                Each website is tailored to your unique specifications, ensuring
          ...
          },
          {
            ...
            para: (
              <>
                Our websites are fine-tuned for speed and efficiency, delivering
          ...
          },
          {
            ...
            para: (
              <>
                We construct adaptable web structures that grow alongside your
                business, adapting to evolving requirements.
              </>
            ),
          },
          {
            ...
            para: (
              <>
                Our proficient support team stands by your side at every step,
    ...
    endingFunnel: {
      ...
      body: (
        <>
          Ready to elevate your online presence? Let our expert team bring your
          vision to life with custom web solutions tailored to your needs.
    ...
    faq: {
      ...
      faqs: [
        {
          id: 1,
          question: <>What makes custom web development the better choice?</>,
          answer: (
            <>
              Compared to template-based solutions, custom development offers
              distinctive features, scalability, and a customized user
              experience
            </>
          ),
        },
        {
          id: 2,
          question: (
            <>What technologies does Sociomatic use for web development?</>
          ),
          answer: (
            <>
              Sociomatic uses state-of-the-art technologies including core
              programing language i.e. Javascript and it&apos;s library ReactJS
              with industry proven framework NextJS and agnostic in terms of
        ...
        },
        {
          id: 3,
          question: (
            <>Are you able to have Sociomatic rework my current website?</>
          ),
          answer: (
            <>
              To improve the look, feel, and general user experience of
              websites, Sociomatic does offer website redesign services.
            </>
          ),
        },
        {
          ...
          answer: (
            <>
              Project complexity affects timelines, but Sociomatic guarantees
              timely development without sacrificing quality
            </>
          ),
        },
        {
          id: 5,
          question: <>Does Sociomatic Provide ongoing website maintenance</>,
          answer: (
            <>
              To guarantee that your website is current and safe, Sociomatic
              does provide continuous support and maintenance
            </>
          ),
        },
      ],
  ...
  software: {
    hero: {
      ...
      body: (
        <>
          We specialize in software development tailored to your unique business
          needs. Our expert team leverages the latest technologies from concept
          to deployment to deliver scalable, innovative software solutions that
    ...
    limitedOffer: {
      ...
      body: {
        para: (
          <>
            Join the ranks of successful businesses poised for exponential
            growth in 2024. Sociomatic is offering exclusive opportunities to
            harness the power of custom software solutions. Contact us now to
            unlock your business&apos;s full potential and stay ahead of the
            competition.
          </>
        ),
        benefits: [],
    ...
    whyWeAndWhatWeDo: {
      ...
      title: (
        <>
          Your <span>Partner</span> in Software Innovation
        </>
      ),
      body: {
        para: (
          <>
            At Sociomatic, we&apos;re passionate about driving digital
            transformation through innovative software solutions. Our dedicated
            team works collaboratively with clients to understand their
            objectives and deliver tailored software applications that
            streamline processes, enhance productivity, and drive business
            growth.
          </>
        ),
        benefits: [
          {
            ...
            paragraph: (
              <>
                ...
                business needs, ensuring optimal functionality efficiency and
                performance
              </>
            ),
          },
          {
            ...
            paragraph: (
              <>
                Our software solutions are designed to scale alongside your
                business, adapting to growth and evolving requirements
              </>
            ),
          },
          {
            ...
            paragraph: (
              <>
                Security is paramount. We implement robust security measures to
          ...
          },
          {
            ...
            paragraph: (
              <>
                Seamless integration with existing systems. We ensure smooth
                interoperability to maximize efficiency and performance
              </>
            ),
          },
          {
            ...
            paragraph: (
              <>
                ur software applications prioritize user experience with
                intuitive interfaces and workflows that enhance usability
              </>
            ),
          },
          {
            ...
            paragraph: (
              <>
                We follow agile methodology to deliver software solutions
                iteratively, ensuring flexibility and rapid deployment.
              </>
            ),
          },
          {
            ...
            paragraph: (
              <>
                We harness the power of cutting-edge technologies, including
                NextJS, NodeJS, and ExpressJS, to develop robust and efficient
                software solutions that meet the demands of modern businesses
              </>
            ),
          },
          {
            ...
            paragraph: (
              <>
                Utilizing AWS(Amazon Web Services), Vercel, and VPS setups, we
                deploy scalable and reliable cloud infrastructure to ensure
                optimal performance and availability for your software
                applications
              </>
            ),
          },
    ...
    userEmpathy: {
      ...
      body: (
        <>
          We understand the challenges you face in making decisions about your
          digital presence. Our empathetic team is here to listen to your needs
          and provide tailored software solutions that align with your vision.
        </>
      ),
    },
    coreBenefits: {
      ...
      body: {
        ...
        benefits: [
          ...
          },
          {
            ...
            para: (
              <>
                Our robust software applications are built to perform
                consistently, providing stability and peace of mind.
              </>
            ),
          },
          {
            ...
            para: (
              <>
                We design scalable software architectures that can grow your
                business, adapting to changing needs and demands
              </>
            ),
          },
          {
            ...
            para: (
              <>
                We focus on security best practices, and we prioritize the
                protection of your data and the integrity of your systems.
              </>
            ),
          },
        ],
    ...
    endingFunnel: {
      tagline: <>Your Digital Future Starts Here</>,
      title: (
        <>
          Partner with Us for Exceptional Cutting-Edge Software
          Solutions,Experience the Sociomatic <>difference</>
        </>
      ),
      body: (
        <>
          Ready to embark on your digital journey? Let Sociomatic be your
          trusted partner in software development. Contact us today to explore
          how our custom software solutions can propel your business to new
          heights of success.
        </>
      ),
      cta: {
    ...
    faq: {
      ...
      faqs: [
        {
          id: 1,
          question: <>Why should my company use custom software development?</>,
          answer: (
            <>
              Tailored software provides flexible, scalable solutions that
              precisely match your company&apos;s goals and requirements.
            </>
          ),
        },
        {
          ...
          answer: (
            <>
              Depending on the particular needs of the project, Sociomatic uses
              a variety of technologies, such as Python, Java, Ruby, and others.
            </>
          ),
        },
        {
          ...
          answer: (
            <>
              To guarantee efficiency and compatibility while integrating new
              software into current systems, Sociomatic offers seamless
        ...
        },
        {
          id: 4,
          question: (
            <>What is the duration required for developing custom software?</>
          ),
          answer: (
            <>
              Project complexity determines timelines, but Sociomatic
              prioritizes speedy development without sacrificing quality.
            </>
          ),
        },
        {
          ...
          question: (
            <>
              Does Sociomatic provide continuous assistance for personalized
              software?
            </>
          ),
          answer: (
            <>
              Sociomatic offers continuous support to ensure your unique
              software stays current, safe, and in line with changing company
              requirements.
            </>
          ),
        },
  ...
  googleanalytics: {
    hero: {
      ...
      body: (
        <>
          Need help understanding your website visitors? Discover a dynamic duo
          - Google Analytics 4 (GA4) and Google Tag Manager (GTM) - that unlocks
          powerful user insights to optimize your marketing funnel and boost
          retention.
        </>
      ),
      cta: {
    ...
    limitedOffer: {
      ...
      body: {
        para: (
          <>
            Sign up for our free one-on-one consultation today and receive a
            customized GA4 and GTM implementation plan (valued at $250) to
            jumpstart your user acquisition and retention strategy!
          </>
        ),
        benefits: [],
      },
    ...
    whyWeAndWhatWeDo: {
      ...
      body: {
        para: (
          <>
            We are experts in guiding approximately 400 businesses through GA4
            and GTM. Here&apos;s what sets us apart
          </>
        ),
        benefits: [
          {
            ...
            paragraph: (
              <>
                Our team possesses in-depth knowledge of GA4 and GTM, ensuring
                optimal implementation for your needs.
              </>
            ),
          },
          {
            ...
            paragraph: (
              <>
                We simplify the setup process, saving you valuable time and
                resources.
              </>
            ),
          },
          {
            ...
            paragraph: (
              <>
                We go beyond data collection, helping you translate insights
                into actionable marketing strategies
              </>
            ),
          },
          {
            ...
            paragraph: (
              <>
                We tailor our approach to your unique website and marketing
                goals.
              </>
            ),
          },
          {
            ...
            paragraph: (
              <>
                We offer ongoing guidance to ensure you continue to leverage the
                full potential of GA4 and GTM.
              </>
            ),
          },
          {
            ...
            paragraph: (
              <>
                ...
                <span>significantly</span>&apos;help 400 businesses improve user
    ...
    userEmpathy: {
      ...
      title: (
        <>
          We understand the challenges of attracting and retaining website
          visitors
        </>
      ),
      body: (
        <>
          We understand the challenges of attracting and retaining website
          visitors. It would help to have a clear picture of user behavior to
          make data-driven decisions. GA4 and GTM can be your secret weapon!
        </>
      ),
    },
    coreBenefits: {
      ...
      body: {
        ...
        benefits: [
          {
            id: 1,
            title: <>Enhanced User Tracking</>,
            para: (
              <>
                Gain a comprehensive understanding of user behavior with
          ...
          },
          {
            ...
            para: (
              <>
                Use GTM to deliver personalized experiences that resonate with
                your audience.
              </>
            ),
          },
          {
            ...
            para: (
              <>
                Make informed marketing decisions based on real-time user data
                and insights.
              </>
            ),
          },
          {
            id: 4,
            title: <>Improved Retention Strategies</>,
            para: (
              <>
                Identify user drop-off points and optimize your funnel for
    ...
    endingFunnel: {
      ...
      title: (
        <>
          Master User Acquisition & Retention with Google&apos;s Powerful Tools
        </>
      ),
      body: (
        <>
          Ready to take your website to the next level? Let us help you leverage
          the combined power of Google Analytics 4 and Google Tag Manager for a
          <span>guaranteed tracking solution with a money-back guarantee.</span>
          Get started for your free one-on-one consultation today and unlock
          valuable user insights that will transform your marketing strategy!
        </>
      ),
      cta: {
        primary: {
