...
const WorkCard = ({
    ...
    return (
        ...
        <div className={`flex gap-[25px] lg:gap-[100px] max-w-[785px] justify-center items-center ${id % 2 === 0 ? "ml-auto flex-row-reverse" : "mr-auto"} shrink-0`}>
            <div className="hidden sm:block">
                {numberImage}
            </div>

            <div className={`flex flex-col min-[380px]:flex-row items-center justify-center small-gap max-w-[625px] ${id % 2 === 0 ? "sm:flex-row-reverse sm:text-right" : ""} [&>svg]:min-w-[100px] [&>svg]:min-h-[100px]`}>
                {image}
