    ...
    <div className="bg-muted">
      <div className="container py-[64px] flex flex-col min-[700px]:flex-row gap-10 items-center justify-center">
        <div className="space-y-[32px] max-w-[600px]">
          <h2 className="text-3xl text-primary leading-normal">
            So when we say, Advertising Is The Only Way To Get Your sales/lead
            And Reach The Level Of Success In Your Business You Want.&nbsp;
            <span className="text-3xl text-secondary relative leading-normal">
              We mean it
            </span>
          </h2>
          <p>
